...
<div class="form-group row">
    ...
    <div class="col-md-10 offset-1">
        ...
        <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address"
            value="{{ $user->teacher->address ?? old('address') }}" autocomplete="address" autofocus>
        ...
        <div class="d-flex flex-wrap">
            ...
            <div class="w-25">
                <input type="checkbox" name="classes[]" id="classes" value="{{ $class->id ?? old('classes') }}"
                    @foreach($user->teacher->classes as $teacherClass)
        ...
        <div class="d-flex flex-wrap">
            ...
            <div class="w-50">
                <input type="checkbox" name="subjects[]" id="subjects" value="{{ $subject->id ?? old('subjects') }}"
                    @foreach($user->teacher->subjects as $teacherSubject)
